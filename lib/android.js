...
function _getApi () {
  ...
  const pending = isArt ? [{
    ...
    functions: {
      ...
      // '_ZN3art6mirror9ArtMethod7ToDexPcEjb': ['ArtMethod::ToDexPc', 'uint32', ['pointer', 'pointer', 'bool']],
    },
    optionals: [
  ...
  if (isArt) {
    ...
    /*
    const toDexPc = temporaryApi['ArtMethod::ToDexPc'];
    Interceptor.replace(toDexPc, new NativeCallback(function (self, pc, abortOnFailure) {
      return toDexPc(self, pc, false);
    }, 'uint32', ['pointer', 'pointer', 'bool']));
    */
  }
